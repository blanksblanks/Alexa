...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to Water Falling. You can say, cover me, to begin playing the sounds of water falling.';
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'Welcome to Water Falling. You can say, give me privacy, to begin playing the sounds of water falling.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to Water Falling. You can say, play the audio to begin playing the sounds of water falling.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to Water Falling. You can say, Next or Previous to navigate through the playlist. ' +
...
var controller = function () {
    return {
        play: function () {
            ...
            var soundcast = audioData[this.attributes['playOrder'][this.attributes['index']]];
            var offsetInMilliseconds = this.attributes['offsetInMilliseconds'];
            // Since play behavior is REPLACE_ALL, enqueuedToken attribute need to be set to null.
            this.attributes['enqueuedToken'] = null;

            if (canThrowCard.call(this)) {
                var cardTitle = 'Playing ' + soundcast.title;
                var cardContent = 'Playing ' + soundcast.title;
                this.response.cardRenderer(cardTitle, cardContent, null);
            }

            this.response.audioPlayerPlay(playBehavior, soundcast.url, token, null, offsetInMilliseconds);
            this.emit(':responseReady');
        },
        stop: function () {
            /*
