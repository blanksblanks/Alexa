...
var audioEventHandlers = Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
    ...
    'PlaybackNearlyFinished' : function () {
        ...
        var soundcast = audioData[this.attributes['playOrder'][enqueueIndex]];
        var expectedPreviousToken = this.attributes['token'];
        var offsetInMilliseconds = 0;
        
        this.response.audioPlayerPlay(playBehavior, soundcast.url, enqueueToken, expectedPreviousToken, offsetInMilliseconds);
